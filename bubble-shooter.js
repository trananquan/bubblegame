...
window.onload = function() {
    ...
    function render() {
        ...
        drawCenterText("Điểm:", scorex, scorey, 150);
        ...
        if (gamestate == gamestates.gameover) {
            ...
            drawCenterText("Click to start", level.x, level.y + level.height / 2 + 200, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Game bắn bóng", 210, 37);
